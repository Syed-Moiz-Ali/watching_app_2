...
class _MangaReaderScreenState extends State<MangaReaderScreen>
  ...
  int _getPageCount(BuildContext context) {
    ...
    return provider.chapterDetail != null ? provider.chapterDetail!.length : 0;
  }
  ...
  Widget _buildHorizontalReader(MangaDetailProvider provider) {
    // final pages = List.from(json.decode(provider.chapterDetail));
    return PageView.builder(
      controller: _pageController,
      // reverse: _isRightToLeft,
      physics: const BouncingScrollPhysics(),
      itemCount: provider.chapterDetail!.length,
      onPageChanged: (index) {
      ...
      itemBuilder: (context, index) {
        return Container(
          ...
          child: GestureDetector(
            ...
            child: Hero(
              tag: 'manga_page_${provider.chapterDetail![index].chapterName}',
              child: ImageWidget(
                imagePath: provider.chapterDetail![index].chapterImage!,
                fit: BoxFit.contain,
  ...
  Widget _buildVerticalReader(MangaDetailProvider provider) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final imagePath = provider.chapterDetail![effectiveIndex].chapterImage!;
        ...
        child: AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              _infoRow('Chapter', provider.chapterDetail!.length.toString()),
