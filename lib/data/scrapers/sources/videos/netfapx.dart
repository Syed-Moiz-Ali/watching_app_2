...
//         case 'image':
//           // log(element
//           //     .querySelector('a > .post-thumbnail > .post-thumbnail-container')!
//           //     .innerHtml
//           //     .toString());
//           return element
//                   .querySelector(
...
//               element
//                   .querySelector(
//                       'a > .post-thumbnail > .post-thumbnail-container > picture > img')
//                   ?.attributes['data-src'] ??
//               '';
//         case 'id':
...
class Netfapx extends BaseScraper {
  Netfapx(ContentSource source) : super(source, source.config!);
