...
extension FavoritesProviderExtension on FavoritesProvider {
  Future<bool> removeWithConfirmation(
    ...
    final bool shouldRemove = await showDialog<bool>(
          ...
          builder: (BuildContext context) => RemoveFavoriteDialog(
            item: item,
...
class RemoveFavoriteDialog extends StatefulWidget {
  ...
  @override
  State<RemoveFavoriteDialog> createState() => _RemoveFavoriteDialogState();
}

class _RemoveFavoriteDialogState extends State<RemoveFavoriteDialog>
